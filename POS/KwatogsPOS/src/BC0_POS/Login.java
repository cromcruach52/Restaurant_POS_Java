...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        username.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 102)));

        password.setBackground(new java.awt.Color(14, 18, 14));
        password.setForeground(new java.awt.Color(255, 255, 102));
        password.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 102)));
        ...
        Password.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(255, 255, 102)));
        Password.setSelectionColor(new java.awt.Color(102, 51, 0));
        ...
        jLabel16.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 102)));
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/Logo Transparent 300px.png"))); // NOI18N
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 60, 300, 220));
    ...
    private void jLabel16MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel16MouseClicked
        ...
        try{
           ...
           else{state.execute("insert into tbllog (`username`,`password`) values ('"+user+"','"+pass+"')");
                panel_login.setVisible(true);
                panel_create.setVisible(false);
                } 
